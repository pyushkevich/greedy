...
=========================================================================*/
#ifndef MULTICOMPONENTUnweightedNCCIMAGEMETRIC_H
#define MULTICOMPONENTUnweightedNCCIMAGEMETRIC_H
...
class ITK_EXPORT MultiComponentUnweightedNCCImageMetric :
    public MultiComponentImageMetricBase<TMetricTraits>
{
public:
  /** Standard class typedefs. */
  typedef MultiComponentUnweightedNCCImageMetric<TMetricTraits> Self;
  ...
  itkTypeMacro( MultiComponentUnweightedNCCImageMetric, MultiComponentImageMetricBase )
...
protected:
  MultiComponentUnweightedNCCImageMetric()
...
private:
  MultiComponentUnweightedNCCImageMetric(const Self&); //purposely not implemented
...
#include "MultiComponentUnweightedNCCImageMetric.txx"
#endif


#endif // MULTICOMPONENTUnweightedNCCIMAGEMETRIC_H
