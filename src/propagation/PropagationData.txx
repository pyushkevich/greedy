...
//namespace propagation
//{
//template class PropagationData<float>;
//template class PropagationData<double>;
//template class TimePointData<float>;
//template class TimePointData<double>;
//}
