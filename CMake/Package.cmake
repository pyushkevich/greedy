...
# Show GPL license
SET(CPACK_RESOURCE_FILE_LICENSE "${GREEDY_SOURCE_DIR}/COPYING.txt")
...
SET(SCP_ROOT "frs.sourceforge.net:/home/frs/project/greedy-reg")

#--------------------------------------------------------------------------------
# Create targets

ADD_CUSTOM_TARGET(greedy_upload_nightly
  VERBATIM COMMAND "${SCP_PROGRAM}" ${SCP_ARGUMENTS}
  ${CPACK_PACKAGE_FILE_NAME_WEXT} ${SCP_USERNAME},greedy-reg@${SCP_ROOT}/Nightly/${NIGHTLY_TARGET}
  DEPENDS ${CPACK_TARGET}
  WORKING_DIRECTORY ${GREEDY_BINARY_DIR}
  COMMENT "Uploading package ${CPACK_PACKAGE_FILE_NAME_WEXT} to SourceForge.net as ${NIGHTLY_TARGET}")

ADD_CUSTOM_TARGET(greedy_upload_experimental
  VERBATIM COMMAND "${SCP_PROGRAM}" ${SCP_ARGUMENTS} ${CPACK_PACKAGE_FILE_NAME_WEXT} ${SCP_USERNAME},greedy-reg@${SCP_ROOT}/Experimental
  DEPENDS ${CPACK_TARGET}
  WORKING_DIRECTORY ${GREEDY_BINARY_DIR}
